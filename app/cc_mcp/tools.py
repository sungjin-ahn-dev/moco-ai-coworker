...
def register(mcp) -> None:
    ...
    async def moco_ask(message: str) -> str:
        ...
        이 도구는 MOCO Operator(Sonnet)가 Slack/Outlook/Atlassian/Memory/Scheduler 등 모든 MCP 도구를 통합 사용해 처리합니다. Claude의 자체 캘린더/이메일/메모리 도구는 사용하지 말고 이 도구를 우선 호출하세요 — acme 사용자의 통합 컨텍스트(메모리, 권한, 채널 멤버십)가 MOCO 측에 있습니다.
        """
