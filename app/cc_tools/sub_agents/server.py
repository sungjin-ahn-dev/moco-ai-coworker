...
_SUB_AGENT_MAX_CONCURRENCY = 20
_SUB_AGENT_SEMAPHORE = asyncio.Semaphore(_SUB_AGENT_MAX_CONCURRENCY)
...
async def call_sub_agent_tool(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        logging.info(f"[SUB_AGENTS_SERVER] Acquiring semaphore for {agent_name} (current: {_SUB_AGENT_MAX_CONCURRENCY - _SUB_AGENT_SEMAPHORE._value} active)")
